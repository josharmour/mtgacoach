...
- MCTS MULTI-PLY TACTICAL SEARCH & DECISION PACKET: When an "=== MCTS MULTI-PLY TACTICAL SEARCH ===" section appears, treat it as the mathematically evaluated forward lookahead:
  * Sequence Recommendation: Align your primary advice with the "⭐ BEST LINE" sequence and explain the immediate tactical rationale and counterplay in crisp, natural Magic terms.
  * Blunder Prevention: If a "⚠️ BLUNDER TRAP DETECTED" is present, explicitly warn the player against that trap line and explain the lethal/crackback risk.
...
- MCTS MULTI-PLY GUIDANCE: When "=== MCTS MULTI-PLY TACTICAL SEARCH ===" is present, base your primary action on the "⭐ BEST LINE" sequence, and warn if a "⚠️ BLUNDER TRAP DETECTED" is present.
