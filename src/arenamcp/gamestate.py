...
Supporting pieces live in sibling modules (extracted 2026-07-23) and are
re-exported here so the public API is unchanged:
- gamestate_models: ZoneType/GameObjectKind enums, GameObject/Zone/Player/TurnInfo dataclasses
- gamestate_transforms: GRE payload normalization helpers
- gamestate_decisions: GRE decision-message handlers
- gamestate_persistence: match-state save/load/resume helpers
"""
...
from arenamcp.gamestate_decisions import (
    ...
    _KNOWN_REQ_TYPES,
    _auto_clear_stale_decision,
    _build_rules_engine_snapshot,
    _handle_actions_available,
    _handle_decision_message,
    _handle_pay_costs,
    _handle_select_n_req,
    _resolve_request_source_context,
    _set_simple_decision,
)
from arenamcp.gamestate_models import (
    GameObject,
    GameObjectKind,
    Player,
    TurnInfo,
...
from arenamcp.gamestate_persistence import (
    MATCH_STATE_MAX_AGE,
    MATCH_STATE_PATH,
    load_match_state,
    mark_match_ended,
...
__all__ = [
    ...
    "save_match_state",
    "validate_log_identity",
    # Re-exported private helpers — tests and sibling modules import these
    # from arenamcp.gamestate, so they must stay importable here.
    "_DECISION_RESPONSE_TYPES",
    "_KNOWN_REQ_TYPES",
    "_auto_clear_stale_decision",
    "_bounded_gre_copy",
...
class GameState(_GameStateAnnotationsMixin):
