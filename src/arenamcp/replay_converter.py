...
from arenamcp.match_validator import MatchFrame, MatchRecording
...
class ReplayConverter:
    ...
    def convert(self, arena_replay_path: Path, output_path: Path | None = None) -> MatchRecording | None:
    ...
    def _detect_trigger(self, msg_type: str, msg: dict) -> str | None:
...
def convert_replay_file(replay_path: Path, output_dir: Path | None = None) -> Path | None:
