...
class ActionDetector:
    ...
    def detect_action(self, response_msg: dict, game_state: dict) -> str | None:
    ...
    def _handle_select_n(self, msg: dict, game_state: dict) -> str | None:
    ...
    def _handle_select_targets(self, msg: dict, game_state: dict) -> str | None:
    ...
    def _handle_modal_choice(self, msg: dict, game_state: dict) -> str | None:
    ...
    def _handle_declare_attackers(self, msg: dict, game_state: dict) -> str | None:
    ...
    def _handle_declare_blockers(self, msg: dict, game_state: dict) -> str | None:
    ...
    def _handle_mulligan(self, msg: dict, game_state: dict) -> str | None:
    ...
    def _get_card_name_by_instance(self, instance_id: int, game_state: dict) -> str | None:
...
# Global instance
_detector: ActionDetector | None = None
...
def detect_player_action(response_msg: dict, game_state: dict) -> str | None:
